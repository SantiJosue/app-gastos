...
const SelectCategorias = ({categoria, cambiarCategoria}) => {
    ...
    const handleClick = (e) => {
        // Accedemos al evento y con la propiedad currentTarget nos va a permitir acceder
        // a un elemento que este dentro de otro.
        // El dataset nos va a permiti acceder a los atributos del elemento,
        // luego accedemos al atributo data-valor. 
            ...
            {mostrarSelect &&
                <Opciones>
                    ...
                    <Opcion 
                        ...
                        onClick={handleClick}
                        >
                        {/* Obtenemos el id para mostrar los distintos iconos */}
